...
{
    public partial class FrmCheckCurrentcy : DevExpress.XtraEditors.XtraForm
    {
        public FrmCheckCurrentcy()
        {
            InitializeComponent();
        }
        ...
        private void BTLoadDS_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //_PathFileINVMST = @"C:\WINDOWS\Temp\INVMST.tps";
                    ...
                    string strsql = string.Format(@"Select SKU,Description,CURRENCYCODE,0 as Check from INVMST where CURRENCYCODE=''");
